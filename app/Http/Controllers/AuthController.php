    ...
    public function register(Request $request)
    {
        ...
        if ($actionType === 'creer') {
            $validated = $request->validate([
                ...
                'email' => 'nullable|string|email|max:255|required_without:telephone|unique:users,email',
                'telephone' => 'nullable|string|max:30|required_without:email|unique:users,telephone',
                ...
                'email.required_without' => 'Indiquez au moins un identifiant de connexion : adresse email ou numéro de téléphone.',
                'telephone.required_without' => 'Indiquez au moins un identifiant de connexion : numéro de téléphone ou adresse email.',
