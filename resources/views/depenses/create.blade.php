    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 text-primary font-weight-bold mb-1">
                <i class="bi bi-graph-down-arrow me-2"></i>Enregistrer une Dépense / Charge
            </h1>
    ...
    <div class="card border-0 shadow-sm rounded-3">
        <div class="card-header bg-white py-3 border-bottom">
            <h5 class="card-title mb-0 fw-bold text-dark">
                <i class="bi bi-receipt text-primary me-2"></i>Détails de la Charge
            </h5>
        </div>
            ...
            <form action="{{ route('depenses.store') }}" method="POST">
                ...
                <div class="mt-4 text-end">
                    <button type="submit" class="btn btn-primary btn-lg fw-bold px-4 shadow-sm">
                        <i class="bi bi-check-circle-fill me-2"></i>Enregistrer la Dépense
                    </button>
                </div>
            </form>
        </div>
