...
<body>
    ...
    <div class="paper-container">
        ...
        <div class="text-center text-muted small mt-4 pt-3 border-top" style="font-size: 10px;">
            {{ config('app.name') }} &bull; {{ auth()->user()->clinique->nom ?? '' }} &bull; Document officiel certifié pour liquidation de Tiers Payant &bull; Émis le {{ \Carbon\Carbon::now()->format('d/m/Y à H:i') }} &bull; Page 1 / 1
        </div>
