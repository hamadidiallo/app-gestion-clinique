    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 text-primary font-weight-bold mb-1">
                <i data-lucide="edit-3" class="me-2"></i>Modifier le Règlement : #{{ $paiement->reference }}
            </h1>
    ...
    <div class="card border-0 shadow-sm rounded-3">
        <div class="card-header bg-white py-3 border-bottom">
            <h5 class="card-title mb-0 fw-bold text-dark">
                <i data-lucide="gear-wide-connected" class="text-primary me-2"></i>Édition de la Fiche de Règlement
            </h5>
        </div>
            ...
            <form action="{{ route('paiements.update', $paiement) }}" method="POST" id="form_paiement_edit">
                ...
                <div class="mt-4 text-end">
                    <button type="submit" class="btn btn-warning btn-lg fw-bold px-4 shadow-sm">
                        <i data-lucide="check-circle" class="me-2"></i>Enregistrer les modifications
                    </button>
                </div>
            </form>
        </div>
