...
@section('title', 'Nouveau Type d\'Acte Médical - ' . config('app.name'))
...
<div class="container-fluid p-0">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-3">
        <div>
            ...
            <h1 class="h3 text-dark fw-bold mb-1 d-flex align-items-center gap-2">
                <i data-lucide="plus-circle" style="width: 1.5rem; height: 1.5rem;" class="text-teal"></i>
                <span>Créer un Type d'Acte Médical</span>
            </h1>
            <p class="text-muted mb-0 small">Ajoutez une nouvelle prestation à la nomenclature clinique avec ses grilles tarifaires et règles de partage.</p>
        </div>
        <div>
    ...
    <div class="row g-4">
        <div class="col-lg-8">
            <form action="{{ route('actes.store') }}" method="POST" id="acteForm">
                @csrf
                    ...
                    <div class="card-body p-4">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="categorie" id="categorie" class="form-select @error('categorie') is-invalid @enderror" required style="border-color: #cbd5e1;">
                                    @foreach($categories as $key => $libelle)
                                        <option value="{{ $key }}" {{ old('categorie', 'consultation') == $key ? 'selected' : '' }}>
                                            {{ $libelle }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="code" id="code" class="form-control font-mono @error('code') is-invalid @enderror" value="{{ old('code') }}" placeholder="Ex: ACT-CGEN-01" required style="border-color: #cbd5e1; text-transform: uppercase;">
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="text" name="nom" id="nom" class="form-control @error('nom') is-invalid @enderror" value="{{ old('nom') }}" placeholder="Ex: Consultation Médecine Générale" required style="border-color: #cbd5e1;">
                                @error('nom')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="description" id="description" rows="3" class="form-control @error('description') is-invalid @enderror" placeholder="Précisions sur la réalisation de l'acte, consommables inclus, consignes..." style="border-color: #cbd5e1;">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="number" step="100" min="0" name="tarif_normal" id="tarif_normal" class="form-control font-mono @error('tarif_normal') is-invalid @enderror" value="{{ old('tarif_normal', 0) }}" required style="border-color: #cbd5e1;">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="number" step="100" min="0" name="tarif_amo" id="tarif_amo" class="form-control font-mono @error('tarif_amo') is-invalid @enderror" value="{{ old('tarif_amo') }}" placeholder="Optionnel" style="border-color: #cbd5e1;">
                                    <span class="input-group-text bg-light text-muted small">FCFA</span>
                                    @error('tarif_amo')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="number" step="100" min="0" name="tarif_specifique" id="tarif_specifique" class="form-control font-mono @error('tarif_specifique') is-invalid @enderror" value="{{ old('tarif_specifique') }}" placeholder="Optionnel" style="border-color: #cbd5e1;">
                                    <span class="input-group-text bg-light text-muted small">FCFA</span>
                    ...
                    <div class="card-body p-4">
                        <div class="row g-3">
                            <div class="col-md-5">
                                ...
                                <div class="input-group">
                                    <input type="number" step="0.5" min="0" max="100" name="part_medecin_pourcentage" id="part_medecin_pourcentage" class="form-control font-mono @error('part_medecin_pourcentage') is-invalid @enderror" value="{{ old('part_medecin_pourcentage', 50.00) }}" required style="border-color: #cbd5e1;">
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="input-group">
                                    <input type="number" step="0.5" min="0" max="100" name="part_clinique_pourcentage" id="part_clinique_pourcentage" class="form-control font-mono @error('part_clinique_pourcentage') is-invalid @enderror" value="{{ old('part_clinique_pourcentage', 50.00) }}" required style="border-color: #cbd5e1;">
                                    <span class="input-group-text bg-light text-muted">%</span>
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm rounded-3 bg-white p-4 mb-4" style="border: 1px solid #e6ebf0 !important;">
                ...
                <div class="small text-muted space-y-3">
                    <p class="mb-2">
                        <strong>Codification :</strong> Utilisez un préfixe logique selon le service pour identifier rapidement l'acte (ex: <code>ACT-CGEN</code> pour consultation générale, <code>ACT-ECHO</code> pour échographie).
                    </p>
                    <p class="mb-2">
                        <strong>Tarif AMO :</strong> Si cet acte est conventionné par la CANAM (Assurance Maladie Obligatoire du Mali), précisez le tarif agréé pour faciliter le calcul automatique du ticket modérateur.
                    </p>
                    <p class="mb-0">
                        <strong>Répartition :</strong> La somme des pourcentages médecin et clinique doit idéalement faire 100%. L'ajustement est automatique lors de la saisie.
                    </p>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm rounded-3 bg-white p-4" style="border: 1px solid #e6ebf0 !important; background: #f8fafc !important;">
                ...
                <div class="d-flex justify-content-between mb-2 small">
                    <span class="text-muted">Tarif saisi :</span>
