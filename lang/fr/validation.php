...
return [
    ...
    | versions, telles que les règles de taille. N'hésitez pas à les modifier.
    |
    */
    ...
    'contains' => 'Le champ :attribute ne contient pas la valeur attendue.',
    ...
    'missing_if' => 'Le champ :attribute doit être omis quand :other a la valeur :value.',
    'missing_unless' => 'Le champ :attribute doit être omis sauf si :other a la valeur :value.',
    'missing_with' => 'Le champ :attribute doit être omis quand :values est présent.',
    'missing_with_all' => 'Le champ :attribute doit être omis quand :values sont présents.',
